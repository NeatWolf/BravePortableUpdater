...
Run the PSScriptAnalyzer command from [VERIFICATION.md](VERIFICATION.md). It
uses an installed analyzer when available and falls back to a temporary module
download when it is not already installed.
